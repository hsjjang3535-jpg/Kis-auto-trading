...
MIN_DROP_PCT = float(os.getenv("CRASH_BOUNCE_MIN_DROP", "5.0"))
MAX_AMOUNT = int(os.getenv("MAX_CRASH_BOUNCE_AMOUNT", "200000"))
MAX_BUY = int(os.getenv("MAX_CRASH_BOUNCE_BUY", "200000"))
MAX_POSITIONS = int(os.getenv("CRASH_BOUNCE_MAX_POSITIONS", "1"))
MAX_API_CALLS = int(os.getenv("CRASH_BOUNCE_MAX_API_CALLS", "20"))
TAKE_PROFIT_PCT = float(os.getenv("CRASH_BOUNCE_TAKE_PROFIT", "2.0"))
